        ...
        return <Fragment>
            ...
            <div class="card">
                ...
                <article class={`card-content article${'direction' in page ? ' ' + page.direction : ''}`} role="article">
                    ...
                    {/* "Read more" button */}
                    {index && page.excerpt ? <a class="article-more button is-small is-size-7" href={`${url_for(page.link || page.path)}#more`}>{`${__('article.more')}: ${page.title || ''}`}</a> : null}
                    {/* Share button */}
            ...
            {/* Comment */}
            {!index && page.layout !== 'page' ? <Comment config={config} page={page} helper={helper} /> : null}
        </Fragment>;
    }
};
